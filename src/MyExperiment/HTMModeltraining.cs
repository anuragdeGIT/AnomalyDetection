...
namespace MyExperiment
{
    public class HTMModeltraining
    {
        ...
        public void RunHTMModelLearning(string trainingfolderPath, string predictingfolderPath, out Predictor predictor)
        {
            ...
            StoredOutputValues.TrainingTimeInSeconds = swh.Elapsed.TotalSeconds;

            Console.WriteLine();
            Console.WriteLine("------------------------------");
            Console.WriteLine();
            Console.WriteLine("HTM Model trained!! Training time is: " + StoredOutputValues.TrainingTimeInSeconds + " seconds.");
            Console.WriteLine();
            Console.WriteLine("------------------------------");
        }
    }
